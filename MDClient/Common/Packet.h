...
#pragma pack(push, 1)
	...
	struct PacketBody
	{
		...
		char PacketData[MaxPacketSize1];
	};
	...
	//- 채널 리스트 요청
	const int MAX_LOBBY_LIST_COUNT = 5;
	...
	const int MAX_NTF_LOBBY_ROOM_LIST_COUNT = 20;
	...
	const int MAX_SEND_LOBBY_USER_LIST_COUNT = 50;
